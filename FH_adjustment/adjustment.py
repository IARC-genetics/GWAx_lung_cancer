...
def check_arg(args=None):
    parser = argparse.ArgumentParser(description='This script double the beta and SE in a GWAx scan from the output of plink ' ,formatter_class=argparse.RawTextHelpFormatter)
